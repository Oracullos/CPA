object frmRelCompromissos: TfrmRelCompromissos
  Left = 513
  Top = 213
  BorderIcons = [biSystemMenu]
  BorderStyle = bsSingle
  Caption = 'Relat'#243'rio de Compromissos'
  ClientHeight = 406
  ClientWidth = 481
  Color = clBtnFace
  ...
  object Panel1: TPanel
    ...
    object edtDataIni: TDateTimePicker
      ...
      Width = 89
      Height = 21
      Date = 41138.000000000000000000
      Time = 41138.000000000000000000
      TabOrder = 2
    end
    ...
    object edtUserIni: TEdit
      ...
      TabOrder = 6
      Text = '0'
      OnDblClick = edtUserIniDblClick
    end
    object edtUserFim: TEdit
      Left = 362
      Top = 149
      Width = 65
      Height = 21
      TabOrder = 7
      Text = '99999'
      OnDblClick = edtUserFimDblClick
    end
    object rdSintetico: TRadioButton
      Left = 152
      Top = 272
      Width = 97
      Height = 17
    ...
    object rdAnalitico: TRadioButton
      Left = 272
      Top = 272
      Width = 73
      Height = 17
  ...
  object qryRelCompromissos: TSQLQuery
    MaxBlobSize = -1
    Params = <>
    SQL.Strings = (
    ...
    Left = 152
    Top = 312
    object qryRelCompromissoscod_cliente: TIntegerField
      FieldName = 'cod_cliente'
    end
    object qryRelCompromissosnome_cliente: TStringField
      FieldName = 'nome_cliente'
      Size = 60
    end
    object qryRelCompromissossolicitante: TStringField
      FieldName = 'solicitante'
      Size = 60
    end
    object qryRelCompromissoscod_usuario: TIntegerField
      FieldName = 'cod_usuario'
    end
    object qryRelCompromissosnome_usuario: TStringField
      FieldName = 'nome_usuario'
      Size = 60
    end
    object qryRelCompromissosdata: TDateField
      FieldName = 'data'
    end
    object qryRelCompromissoshora: TTimeField
      FieldName = 'hora'
    end
    object qryRelCompromissoslocal: TStringField
      FieldName = 'local'
      Size = 100
    end
    object qryRelCompromissosobservacao: TStringField
      FieldName = 'observacao'
      Size = 1000
    end
    object qryRelCompromissoscod_compromisso: TIntegerField
      FieldName = 'cod_compromisso'
    end
    object qryRelCompromissosfinalizado: TStringField
      FieldName = 'finalizado'
      Size = 1
    end
    object qryRelCompromissoscod_chamado: TIntegerField
      FieldName = 'cod_chamado'
    end
    object qryRelCompromissosdata_chamado: TDateField
      FieldName = 'data_chamado'
    end
  end
  object dspCompromissos: TDataSetProvider
    DataSet = qryRelCompromissos
    Left = 184
    Top = 312
  end
  object cdsRelCompromissos: TClientDataSet
    Active = True
    Aggregates = <>
    Params = <>
    ...
    Left = 216
    Top = 312
    object cdsRelCompromissoscod_cliente: TIntegerField
      FieldName = 'cod_cliente'
    end
    object cdsRelCompromissosnome_cliente: TStringField
      FieldName = 'nome_cliente'
      Size = 60
    end
    object cdsRelCompromissossolicitante: TStringField
      FieldName = 'solicitante'
      Size = 60
    end
    object cdsRelCompromissoscod_usuario: TIntegerField
      FieldName = 'cod_usuario'
    end
    object cdsRelCompromissosnome_usuario: TStringField
      FieldName = 'nome_usuario'
      Size = 60
    end
    object cdsRelCompromissosdata: TDateField
      FieldName = 'data'
    end
    object cdsRelCompromissoshora: TTimeField
      FieldName = 'hora'
    end
    object cdsRelCompromissoslocal: TStringField
      FieldName = 'local'
      Size = 100
    end
    object cdsRelCompromissosobservacao: TStringField
      FieldName = 'observacao'
      Size = 1000
    end
    object cdsRelCompromissoscod_compromisso: TIntegerField
      FieldName = 'cod_compromisso'
    end
    object cdsRelCompromissosfinalizado: TStringField
      FieldName = 'finalizado'
      Size = 1
    end
    object cdsRelCompromissoscod_chamado: TIntegerField
      FieldName = 'cod_chamado'
    end
    object cdsRelCompromissosdata_chamado: TDateField
      FieldName = 'data_chamado'
    end
  end
  object dsRelatorio: TDataSource
    DataSet = cdsRelCompromissos
    Left = 112
    Top = 312
  end
