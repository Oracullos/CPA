...
begin
     ...
     if Sender.AsString = 'N' then Text := 'Não';
end;
...
begin
     ...
     try
          ...
          try
               ...
               MessageDlg('Não foi possível efetuar a Conexão com: '+nomeconexao,
                         mtError, [mbOk], 0);
               result := true;
...
begin
     ...
     begin
          try
               ...
               begin
                    MessageDlg('Não foi possível efetuar a conexão principal',
                              mtError, [mbOk], 0);
                    Abort();
               end;
          end;
...
begin
     ...
     begin
          MessageDlg('Não foi possível localizar o arquivo '+Caminho+'conexao.ini'+
                     'Verifique',
                         mtError, [mbOk], 0);
...
begin
     ...
     if Sender.AsString = 'A' then Text := 'Não Aplica';
end;
...
begin
     ...
     if Sender.AsBoolean = false then Text := 'Não';
end;
