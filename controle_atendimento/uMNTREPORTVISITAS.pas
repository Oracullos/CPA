...
begin
     ...
     begin
          ShowMessage('O contato não pode ser nulo! ');
          edtContato.SetFocus;
          Abort;
     end;
     if edtData.Date = Null then
     begin
          ShowMessage('A data da visita não pode ser nula! ');
          edtData.SetFocus;
          Abort;
     end;
     if edtHrIni.Text = '  :  ' then
     begin
          ShowMessage('A hora inicial da visita não pode ser nula! ');
          edtHrIni.SetFocus;
          Abort;
     end;
     if edtHrFim.Text = '  :  ' then
     begin
          ShowMessage('A hora final da visita não pode ser nula! ');
          edtHrFim.SetFocus;
          Abort;
     end;
     ...
     begin
          ShowMessage('O motivo da visita não pode ser nulo! ');
          mmoMotivoVisita.SetFocus;
          Abort;
     end;
     if mmoTarefaExecutada.Text = '' then
     begin
          ShowMessage('A tarefa executada não pode ser nula! ');
...
begin
     ...
     begin
          ...
          begin
               ShowMessage('Hora inicial da visita é maior que a hora de finalização. Por favor, verifique!');
               edtHrFim.SetFocus;
               Abort;
          end;
     end
