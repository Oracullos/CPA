...
begin
     ...
     begin
          ...
          sbPrincipal.Panels[2].Text := 'Definição: '+definicao;
          sbPrincipal.Panels[3].Text := 'Área: '+des_area;
...
begin
     ...
     begin
          ...
          else     // M A I Ú S C U L A S        M A I Ú S C U L A S
...
begin
     ...
     begin
          ...
          if achou = false then
          begin
               MessageDlg('Existem caracteres inválidos para a senha. Por favor verifique!',
                          mtError, [mbOk], 0);
               Abort();
          end;
     end;
...
begin
     ...
     begin
          ShowMessage('O cliente inicial não pode ser nulo');
          edtCliIni.SetFocus;
          Abort;
     end;
     ...
     begin
          ShowMessage('O cliente final não pode ser nulo');
          edtCliFim.SetFocus;
          Abort;
     end;
