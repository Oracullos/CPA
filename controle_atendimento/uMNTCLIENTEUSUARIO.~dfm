object frmMntClienteUsuario: TfrmMntClienteUsuario
  Left = 587
  Top = 211
  BorderIcons = [biSystemMenu]
  BorderStyle = bsSingle
  Caption = 'Manuten'#231#227'o Permiss'#245'es de Usu'#225'rios'
  ClientHeight = 362
  ClientWidth = 486
  Color = clBtnFace
  ...
  object Panel1: TPanel
    ...
    object chxSuporte: TDBCheckBox
      Left = 94
      Top = 163
      Width = 141
      Height = 17
      Caption = 'Permiss'#227'o de Suporte'
      DataField = 'permissao_suporte'
      DataSource = dsPermissao
      TabOrder = 6
      ValueChecked = 'Sim'
      ValueUnchecked = 'N'#227'o'
    end
    object chxAbrirChamado: TDBCheckBox
      Left = 253
      Top = 163
      Width = 172
      Height = 17
      Caption = 'Permiss'#227'o p/ Abrir Chamado'
      DataField = 'permissao_abrir_chamado'
      DataSource = dsPermissao
      TabOrder = 7
      ValueChecked = 'Sim'
      ValueUnchecked = 'N'#227'o'
  ...
  object dsPermissao: TDataSource
    DataSet = dmPrincipal.cdsCliente_usuario
    Left = 8
    Top = 120
  end
end
