object frmGraficoOrigemporCliente: TfrmGraficoOrigemporCliente
  Left = 339
  Top = 180
  BorderIcons = [biSystemMenu]
  BorderStyle = bsSingle
  Caption = 'Grafico Origem do Chamado por Cliente'
  ClientHeight = 637
  ClientWidth = 948
  Color = clBtnFace
  ...
  object KorpChart1: TKorpChart
    ...
    Charts = <
      item
        ...
        RotateNames = True
        DataSource = dsOrigem
        XValueFieldName = 'origem_chamado'
        ...
        SubTitle = 'Origem dos Chamados por Cliente'
        xAxisName = 'ORIGEM DO CHAMADO'
        yAxisName = 'TOTAL'
  ...
  object qryGraficoOrigem: TSQLQuery
    MaxBlobSize = -1
    Params = <
      item
        DataType = ftUnknown
    ...
    SQL.Strings = (
      'select origem_chamado, count(origem_chamado) as total'
      'from chamado'
      'where data_chamado between :dataini and :datafim'
      'and cod_cliente between :cliente and :clientefim'
      'group by origem_chamado')
    SQLConnection = dmPrincipal.conpg
    Left = 816
    Top = 160
    object qryGraficoOrigemorigem_chamado: TStringField
      FieldName = 'origem_chamado'
    end
    object qryGraficoOrigemtotal: TLargeintField
      FieldName = 'total'
    end
  end
  object dspOrigem: TDataSetProvider
    DataSet = qryGraficoOrigem
    Left = 848
    Top = 160
  end
  object cdsGraficoOrigem: TClientDataSet
    Aggregates = <>
    Params = <
      item
        DataType = ftUnknown
    ...
    Left = 880
    Top = 160
    object cdsGraficoOrigemorigem_chamado: TStringField
      FieldName = 'origem_chamado'
    end
    object cdsGraficoOrigemtotal: TLargeintField
      FieldName = 'total'
    end
  end
  object dsOrigem: TDataSource
    DataSet = cdsGraficoOrigem
    Left = 832
    Top = 128
  end
end
