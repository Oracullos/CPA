object frmCadUsuario: TfrmCadUsuario
  ...
  object PageControl1: TPageControl
    ...
    object TabSheet1: TTabSheet
      ...
      object Panel1: TPanel
        ...
        object btnBuscaArea: TSpeedButton
          Left = 440
          Top = 49
          Width = 33
          Height = 31
          ...
          OnClick = btnBuscaAreaClick
        end
        object chxAtivo: TDBCheckBox
          Left = 232
          Top = 32
          Width = 97
          Height = 17
      ...
      object cbxDefinicao: TDBComboBox
        Left = 160
        Top = 137
        Width = 177
        Height = 21
        ...
        Items.Strings = (
          ...
          'RECEBE E-MAIL')
        TabOrder = 4
        OnChange = cbxDefinicaoChange
      end
      object chxTodosChamados: TDBCheckBox
        Left = 124
        Top = 169
        Width = 161
        Height = 17
        Caption = 'Permite ver todos chamados'
        DataField = 'permite_ver_todos_chmados'
        DataSource = dsUsuario
        Enabled = False
        TabOrder = 5
        ValueChecked = 'Sim'
      ...
      object GroupBox1: TGroupBox
        ...
        object edtSenhaConta: TMaskEdit
          Left = 159
          Top = 76
          Width = 178
          Height = 21
        ...
        object edtUsuarioConta: TDBEdit
          Left = 160
          Top = 104
          Width = 177
          Height = 21
          DataField = 'usuario_conta'
          DataSource = dsUsuario
          Enabled = False
          TabOrder = 3
        end
        object edtPortaSaida: TDBEdit
          Left = 160
          Top = 130
          Width = 57
          Height = 21
      ...
      object GroupBox2: TGroupBox
        ...
        object edtSenhaLogin: TMaskEdit
          Left = 158
          Top = 55
          Width = 204
          Height = 21
      ...
      object chxRecebeEmail: TDBCheckBox
        Left = 290
        Top = 169
        Width = 209
        Height = 17
        Caption = 'Recebe e-mail de registro de altera'#231#245'es'
        DataField = 'receber_reg_alteracao'
        DataSource = dsUsuario
        Enabled = False
        TabOrder = 8
        ValueChecked = 'Sim'
  ...
  object dsUsuario: TDataSource
    DataSet = dmPrincipal.cdsUsuario
    Left = 12
    Top = 168
  end
end
