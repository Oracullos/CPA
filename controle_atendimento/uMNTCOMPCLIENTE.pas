...
begin
     ...
     begin
          ShowMessage('O código do cliente não pode ser nulo! ');
          edtCodCliente.SetFocus;
          Abort;
     end;
     if (edtCodUsuario.Text = '') or (edtNomeUsuario.Text = '') then
     begin
          ShowMessage('O código do usuário não pode ser nulo! ');
          edtCodUsuario.SetFocus;
          Abort;
     end;
     ...
     begin
          ShowMessage('A hora não pode ser nula! ');
          edtHora.SetFocus;
          Abort;
     end;
     if edtLocal.Text = '' then
     begin
          ShowMessage('O local do compromisso não pode ser nulo! ');
          edtLocal.SetFocus;
          Abort;
     end;
     if dsCompromisso.State in [dsInsert] then
