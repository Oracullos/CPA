object frmGraficoCategoriasporCliente: TfrmGraficoCategoriasporCliente
  Left = 348
  Top = 127
  BorderIcons = [biSystemMenu]
  BorderStyle = bsSingle
  Caption = 'Gr'#225'fico de Categorias por Cliente'
  ClientHeight = 637
  ClientWidth = 948
  Color = clBtnFace
  ...
  object KorpChart1: TKorpChart
    ...
    Charts = <
      item
        ...
        XValueFieldName = 'desc_categoria'
        ...
        SubTitle = 'Categoria dos Chamados por Cliente'
        xAxisName = 'CATEGORIA'
        yAxisName = 'TOTAL'
  ...
  object qryGraficoCliente: TSQLQuery
    MaxBlobSize = -1
    Params = <
      item
        DataType = ftUnknown
    ...
    SQL.Strings = (
      'select desc_categoria, count(cod_categoria) as total'
      'from chamado'
    ...
    Left = 696
    Top = 168
    object qryGraficoClientedesc_categoria: TStringField
      FieldName = 'desc_categoria'
      Size = 60
    end
    object qryGraficoClientetotal: TLargeintField
      FieldName = 'total'
    end
  end
  object dspCliente: TDataSetProvider
    DataSet = qryGraficoCliente
    Left = 728
    Top = 168
  end
  object cdsGraficoCliente: TClientDataSet
    Aggregates = <>
    Params = <
      item
        DataType = ftUnknown
    ...
    Left = 760
    Top = 168
    object cdsGraficoClientedesc_categoria: TStringField
      FieldName = 'desc_categoria'
      Size = 60
    end
    object cdsGraficoClientetotal: TLargeintField
      FieldName = 'total'
    end
  end
  object dsCliente: TDataSource
    DataSet = cdsGraficoCliente
    Left = 720
    Top = 136
  end
end
