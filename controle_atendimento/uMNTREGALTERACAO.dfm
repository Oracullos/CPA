object frmMntRegistroAlteracao: TfrmMntRegistroAlteracao
  Left = 677
  Top = 215
  ActiveControl = edtCodResp
  BorderStyle = bsSingle
  Caption = 'Manuten'#231#227'o Registro de Altera'#231#245'es'
  ClientHeight = 427
  ClientWidth = 618
  Color = clBtnFace
  ...
  object PageControl1: TPageControl
    ...
    object TabSheet1: TTabSheet
      ...
      object Label2: TLabel
        ...
        Width = 159
        Height = 13
        Caption = 'Respons'#225'vel pela altera'#231#227'o'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Height = -11
        Font.Name = 'MS Sans Serif'
      ...
      object edtBuscarUser: TSpeedButton
        Left = 481
        Top = 48
        Width = 33
        Height = 25
      ...
      object edtCodResp: TDBEdit
        ...
        TabOrder = 1
        OnExit = edtCodRespExit
        OnKeyDown = edtCodRespKeyDown
      end
      ...
      object mmoDescAlteracao: TDBMemo
        ...
        Width = 401
        Height = 114
        DataField = 'desc_alteracao'
        DataSource = dsRegistro
        ScrollBars = ssVertical
        TabOrder = 7
        OnEnter = mmoDescAlteracaoEnter
        OnExit = mmoDescAlteracaoExit
      end
  ...
  object dsRegistro: TDataSource
    DataSet = dmPrincipal.cdsRegAlteracao
    Left = 12
    Top = 48
  end
end
