object frmGraficoStatusporCliente: TfrmGraficoStatusporCliente
  Left = 381
  Top = 180
  BorderIcons = [biSystemMenu]
  BorderStyle = bsSingle
  Caption = 'Gr'#225'fico Status do Chamado por Cliente'
  ClientHeight = 637
  ClientWidth = 948
  Color = clBtnFace
  ...
  object KorpChart1: TKorpChart
    ...
    Charts = <
      item
        ...
        SubTitle = 'Status dos Chamados por Cliente'
        xAxisName = 'STATUS DO CHAMADO'
        yAxisName = 'TOTAL'
  ...
  object qryGrafico_cliente: TSQLQuery
    MaxBlobSize = -1
    Params = <
      item
        DataType = ftUnknown
    ...
    Left = 688
    Top = 176
    object qryGrafico_clientedesc_status: TStringField
      FieldName = 'desc_status'
      Size = 60
    end
    object qryGrafico_clientetotal: TLargeintField
      FieldName = 'total'
    end
  end
  object dsGrafico: TDataSource
    DataSet = cdsGrafico_cliente
    Left = 696
    Top = 136
  end
  object dspCliente: TDataSetProvider
    DataSet = qryGrafico_cliente
    Left = 720
    Top = 176
  end
  object cdsGrafico_cliente: TClientDataSet
    Aggregates = <>
    Params = <
      item
        DataType = ftUnknown
    ...
    Left = 752
    Top = 176
    object cdsGrafico_clientedesc_status: TStringField
      FieldName = 'desc_status'
      Size = 60
    end
    object cdsGrafico_clientetotal: TLargeintField
      FieldName = 'total'
    end
  end
end
