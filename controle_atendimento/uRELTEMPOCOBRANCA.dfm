object frmRelTempoCobrancaCliente: TfrmRelTempoCobrancaCliente
  Left = 410
  Top = 194
  BorderIcons = [biSystemMenu]
  BorderStyle = bsSingle
  Caption = 'Relat'#243'rio Tempo para Cobran'#231'a por Cliente'
  ClientHeight = 347
  ClientWidth = 489
  Color = clBtnFace
  ...
  object Panel1: TPanel
    ...
    object edtDataini: TDateTimePicker
      ...
      Width = 105
      Height = 21
      Date = 41150.000000000000000000
      Time = 41150.000000000000000000
      TabOrder = 0
    end
  ...
  object qryRelTempoCobranca: TSQLQuery
    MaxBlobSize = -1
    Params = <>
    SQL.Strings = (
      'select * from chamado order by cod_cliente, cod_chamado')
    SQLConnection = dmPrincipal.conpg
    Left = 368
    Top = 160
    object qryRelTempoCobrancacod_chamado: TIntegerField
      FieldName = 'cod_chamado'
    end
    object qryRelTempoCobrancacod_cliente: TIntegerField
      FieldName = 'cod_cliente'
    end
    object qryRelTempoCobrancacod_status: TIntegerField
      FieldName = 'cod_status'
    end
    object qryRelTempoCobrancacod_categoria: TIntegerField
      FieldName = 'cod_categoria'
    end
    object qryRelTempoCobrancanome_cliente: TStringField
      FieldName = 'nome_cliente'
      Size = 60
    end
    object qryRelTempoCobrancadesc_status: TStringField
      FieldName = 'desc_status'
      Size = 60
    end
    object qryRelTempoCobrancadesc_categoria: TStringField
      FieldName = 'desc_categoria'
      Size = 60
    end
    object qryRelTempoCobrancadata_chamado: TDateField
      FieldName = 'data_chamado'
    end
    object qryRelTempoCobrancahora_chamado: TTimeField
      FieldName = 'hora_chamado'
    end
    object qryRelTempoCobrancaprazo_fim_chamdo: TDateField
      FieldName = 'prazo_fim_chamdo'
    end
    object qryRelTempoCobrancachamado_automatico: TStringField
      FieldName = 'chamado_automatico'
      Size = 1
    end
    object qryRelTempoCobrancanivel_prioridade: TStringField
      FieldName = 'nivel_prioridade'
      Size = 1
    end
    object qryRelTempoCobrancadescricao_chamado: TStringField
      FieldName = 'descricao_chamado'
      Size = 2000
    end
    object qryRelTempoCobrancacaminho_arq: TStringField
      FieldName = 'caminho_arq'
      Size = 200
    end
    object qryRelTempoCobrancacod_usuario_resp: TIntegerField
      FieldName = 'cod_usuario_resp'
    end
    object qryRelTempoCobrancanome_usuario_resp: TStringField
      FieldName = 'nome_usuario_resp'
      Size = 60
    end
    object qryRelTempoCobrancanome_usuario_abriu: TStringField
      FieldName = 'nome_usuario_abriu'
      Size = 60
    end
    object qryRelTempoCobrancacod_usuario_abriu: TIntegerField
      FieldName = 'cod_usuario_abriu'
    end
    object qryRelTempoCobrancafuncionario_emp: TStringField
      FieldName = 'funcionario_emp'
      Size = 60
    end
    object qryRelTempoCobrancaorigem_chamado: TStringField
      FieldName = 'origem_chamado'
    end
    object qryRelTempoCobrancatempo_gasto: TFMTBCDField
      FieldName = 'tempo_gasto'
      Precision = 15
      Size = 2
    end
    object qryRelTempoCobrancadata_final: TDateField
      FieldName = 'data_final'
    end
    object qryRelTempoCobrancahora_final: TTimeField
      FieldName = 'hora_final'
    end
    object qryRelTempoCobrancagera_compromisso: TStringField
      FieldName = 'gera_compromisso'
      Size = 1
    end
    object qryRelTempoCobrancatempo_cobranca: TFMTBCDField
      FieldName = 'tempo_cobranca'
      Precision = 15
      Size = 2
    end
    object qryRelTempoCobrancareincidencia: TStringField
      FieldName = 'reincidencia'
      Size = 1
    end
    object qryRelTempoCobrancahora_gravacao: TTimeField
      FieldName = 'hora_gravacao'
    end
    object qryRelTempoCobrancadata_gravacao: TDateField
      FieldName = 'data_gravacao'
    end
  end
  object dspTmpCobranca: TDataSetProvider
    DataSet = qryRelTempoCobranca
    Left = 400
    Top = 160
  end
  object cdsRelTempoCobranca: TClientDataSet
    Aggregates = <>
    Params = <>
    ProviderName = 'dspTmpCobranca'
    Left = 432
    Top = 160
    object cdsRelTempoCobrancacod_chamado: TIntegerField
      FieldName = 'cod_chamado'
    end
    object cdsRelTempoCobrancacod_cliente: TIntegerField
      FieldName = 'cod_cliente'
    end
    object cdsRelTempoCobrancacod_status: TIntegerField
      FieldName = 'cod_status'
    end
    object cdsRelTempoCobrancacod_categoria: TIntegerField
      FieldName = 'cod_categoria'
    end
    object cdsRelTempoCobrancanome_cliente: TStringField
      FieldName = 'nome_cliente'
      Size = 60
    end
    object cdsRelTempoCobrancadesc_status: TStringField
      FieldName = 'desc_status'
      Size = 60
    end
    object cdsRelTempoCobrancadesc_categoria: TStringField
      FieldName = 'desc_categoria'
      Size = 60
    end
    object cdsRelTempoCobrancadata_chamado: TDateField
      FieldName = 'data_chamado'
    end
    object cdsRelTempoCobrancahora_chamado: TTimeField
      FieldName = 'hora_chamado'
    end
    object cdsRelTempoCobrancaprazo_fim_chamdo: TDateField
      FieldName = 'prazo_fim_chamdo'
    end
    object cdsRelTempoCobrancachamado_automatico: TStringField
      FieldName = 'chamado_automatico'
      Size = 1
    end
    object cdsRelTempoCobrancanivel_prioridade: TStringField
      FieldName = 'nivel_prioridade'
      Size = 1
    end
    object cdsRelTempoCobrancadescricao_chamado: TStringField
      FieldName = 'descricao_chamado'
      Size = 2000
    end
    object cdsRelTempoCobrancacaminho_arq: TStringField
      FieldName = 'caminho_arq'
      Size = 200
    end
    object cdsRelTempoCobrancacod_usuario_resp: TIntegerField
      FieldName = 'cod_usuario_resp'
    end
    object cdsRelTempoCobrancanome_usuario_resp: TStringField
      FieldName = 'nome_usuario_resp'
      Size = 60
    end
    object cdsRelTempoCobrancanome_usuario_abriu: TStringField
      FieldName = 'nome_usuario_abriu'
      Size = 60
    end
    object cdsRelTempoCobrancacod_usuario_abriu: TIntegerField
      FieldName = 'cod_usuario_abriu'
    end
    object cdsRelTempoCobrancafuncionario_emp: TStringField
      FieldName = 'funcionario_emp'
      Size = 60
    end
    object cdsRelTempoCobrancaorigem_chamado: TStringField
      FieldName = 'origem_chamado'
    end
    object cdsRelTempoCobrancatempo_gasto: TFMTBCDField
      FieldName = 'tempo_gasto'
      Precision = 15
      Size = 2
    end
    object cdsRelTempoCobrancadata_final: TDateField
      FieldName = 'data_final'
    end
    object cdsRelTempoCobrancahora_final: TTimeField
      FieldName = 'hora_final'
    end
    object cdsRelTempoCobrancagera_compromisso: TStringField
      FieldName = 'gera_compromisso'
      Size = 1
    end
    object cdsRelTempoCobrancatempo_cobranca: TFMTBCDField
      FieldName = 'tempo_cobranca'
      Precision = 15
      Size = 2
    end
    object cdsRelTempoCobrancareincidencia: TStringField
      FieldName = 'reincidencia'
      Size = 1
    end
    object cdsRelTempoCobrancahora_gravacao: TTimeField
      FieldName = 'hora_gravacao'
    end
    object cdsRelTempoCobrancadata_gravacao: TDateField
      FieldName = 'data_gravacao'
    end
  end
  object dsRelatorio: TDataSource
    DataSet = cdsRelTempoCobranca
    Left = 400
    Top = 192
  end
  ...
  object ppReport1: TppReport
    ...
    object ppHeaderBand1: TppHeaderBand
      ...
      object ppLabel1: TppLabel
        ...
        Caption = 'Relat'#243'rio de Tempo para Cobran'#231'a'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlack
        Font.Name = 'Arial'
        Font.Size = 13
    ...
    object ppFooterBand1: TppFooterBand
      ...
      object ppLabel13: TppLabel
        ...
        Border.Visible = False
        Border.Weight = 1.000000000000000000
        Caption = 'Total Geral de Tempo p/ Cobran'#231'a:'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlack
        Font.Name = 'Arial'
        Font.Size = 8
    ...
    object ppGroup1: TppGroup
      ...
      object ppGroupFooterBand1: TppGroupFooterBand
        ...
        object ppLabel12: TppLabel
          ...
          Border.Visible = False
          Border.Weight = 1.000000000000000000
          Caption = 'Total Tempo p/ Cobran'#231'a:'
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
          Font.Name = 'Arial'
          Font.Size = 8
