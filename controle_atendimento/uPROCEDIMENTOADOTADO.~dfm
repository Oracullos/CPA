object frmProcedimentoAdotado: TfrmProcedimentoAdotado
  Left = 536
  Top = 216
  ...
  object Label1: TLabel
    ...
    Width = 225
    Height = 13
    Caption = 'Procedimento Adotado no Atendimento:'
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWindowText
    Font.Height = -11
    Font.Name = 'MS Sans Serif'
  ...
  object Label2: TLabel
    ...
    Width = 116
    Height = 13
    Caption = 'Anexar arquivo no e-mail'
  end
  object Label3: TLabel
    ...
    Width = 134
    Height = 13
    Caption = 'Tempo Cobran'#231'a (em horas)'
  end
  object mmoProcedimento_Adotado: TMemo
    Left = 8
    Top = 29
    Width = 409
    Height = 140
    ...
    ShowHint = True
    TabOrder = 0
    OnKeyPress = mmoProcedimento_AdotadoKeyPress
  end
